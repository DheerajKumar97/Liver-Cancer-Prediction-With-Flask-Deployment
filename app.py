...
def predict():
	...
	if request.method == 'POST':
		...
		print(prediction)
		prediction_label = {"LIVER CANCER POSITIVE":1,"LIVER CANCER NEGATIVE":2}
		...
		pred_probalility_score = {"LIVER CANCER POSITIVE":pred_prob[0][0]*100,"LIVER CANCER NEGATIVE":pred_prob[0][1]*100}
